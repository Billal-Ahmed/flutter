...
final User james = User(
  id: 4,
  name: 'Mushahid Hussain bai',
  imageUrl: 'assets/t.jpg',
);
final User mohammed = User(
  id: 5,
  name: 'PM Khan ',
  imageUrl: 'assets/imrankhan.jpg',
);
...
final User mia = User(
  id: 8,
  name: 'Sir Azam DC',
  imageUrl: 'assets/sirazam.png',
);
final User eve = User(
  id: 9,
  name: 'Riswan bai DC',
  imageUrl: 'assets/riswan.enc',
);
final User aisha = User(
  id: 10,
  name: 'Salman bai DC',
  imageUrl: 'assets/salman.enc',
);
...
List<Message> groupChats = [
  Message(
    sender: manUtd,
    time: '5:40 PM',
    text: 'China la atoooooo!',
    unread: false,
  ),
  Message(
    sender: friends,
    time: '4:09 PM',
    text: 'han laaaaaaaaa kakoooo!',
    unread: true,
  ),
  Message(
    sender: developers,
    time: '12:02 PM',
    text: ' Ala kacousin juuuuuuu!',
    unread: false,
  ),
  Message(
    sender: family,
    time: '3:37 PM',
    text: 'han laaaaaaaa baai.',
    unread: false,
  ),
  Message(
    sender: computerScience,
    time: '2:32 PM',
    text: 'la atooo ga yoooooooooo!!',
    unread: true,
  ),
];
